...
The Unigrid project is currently in its early stages, and The Unigrid Foundation, a recently established organization, handles all token sales. Despite its youth, the project has garnered significant interest. In the event that the foundation sells all the reserved tokens to accredited investors and VC firms before the scheduled sales date for each round, it will enable early token holders from the community to participate and offer their tokens for sale in the upcoming rounds. This provides an opportunity for additional investors to enter the picture, although the quantity of tokens available (approximately 6.4 million) is relatively small.

The sales rounds are open to almost everyone, irrespective of their country of residence. However, it is important to note that the foundation adheres to Swedish law and actively combats money laundering. Consequently, a vetting process incorporating KYC (know your customer) functionality is in place to ensure that both buyers and sellers meet the eligibility criteria for participation in the sale.
