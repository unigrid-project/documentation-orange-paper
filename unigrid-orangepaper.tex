...
\begin{flushleft}
	...
	\center \small
	\begin{tabular}{{lrrr}}
		\rowcolor{orange}\color{black}\textbf{Round 1}, Target Date: December 2021\hspace{4cm} & \color{black}Option 1 & \color{black}Option 2\\
...
\begin{flushleft}
	...
	\begin{tabular}{lrrrrr}
		\rowcolor{orange}\color{black}\textbf{Round 2}, Target Date: November 2022\hspace{1.9cm} & \color{black}Option 1 & \color{black}Option 2 & \color{black}Option 3\\
...
\begin{flushleft}
	...
	\center \small
	\begin{tabular}{lrrrrr}
		\rowcolor{orange}\color{black}\textbf{Round 3}, Target Date: May 2023\hspace{2.35cm} & \color{black}Option 1 & \color{black}Option 2 & \color{black}Option 3\\
